...
module	wbdblpriarb(i_clk, i_reset,
	...
	//
	// F_OPT_CLK2FFLOGIC shouldn't be needed.  However, if this component is being
	// used as a component of a multi-clock formal design, then it will be necessary.
	// Set this any-time the design is being built with the yosys clk2fflogic command
	// used as part of the yosys script.
