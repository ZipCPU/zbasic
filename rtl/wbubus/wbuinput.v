...
module	wbuinput (
	...
	wbutohex	tobits(i_clk, i_reset, i_stb, i_byte, o_soft_reset,
				hx_stb, hx_valid, hx_hexbits);

	wbureadcw	formcw(i_clk, i_reset, hx_stb, hx_valid, hx_hexbits,
				cw_stb, cw_word);
...
`else
	wbudecompress	unpack(i_clk, i_reset,
				cw_stb, cw_word, o_stb, o_codword);
`endif
