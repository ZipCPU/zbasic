...
`endif
	...
	wbxbar #(
		...
		.SLAVE_ADDR({
			...
			{ 23'h380000 }, //        bkram: 0x0e00000
			{ 23'h300000 }, //       wb_sio: 0x0c00000
			{ 23'h280000 }, //          rtc: 0x0a00000
			{ 23'h200000 }, //         uart: 0x0800000
			{ 23'h180000 }, //       sdcard: 0x0600000
			{ 23'h100000 }, // scope_sdcard: 0x0400000
...
`else	// RTC_ACCESS
	...
	//
	// In the case that there is no rtc peripheral
	// responding on the wb bus
	assign	rtc_ack   = 1'b0;
	assign	rtc_err   = (rtc_stb);
	assign	rtc_stall = 0;
	assign	rtc_data  = 0;
...
`ifdef	SDSPI_SCOPE
	assign	scope_sdcard_trigger = (wb_sdcard_stb)&&(wb_sdcard_we);
	assign	scope_sdcard_ce = 1'b1;
	wbscope #(5'h9) sdspiscope(i_clk, scope_sdcard_ce,
			scope_sdcard_trigger,
			sdspi_debug, i_clk,
			wb_scope_sdcard_cyc, wb_scope_sdcard_stb, wb_scope_sdcard_we,
			wb_scope_sdcard_addr[1-1:0],
			wb_scope_sdcard_data, // 32 bits wide
			wb_scope_sdcard_sel,  // 32/8 bits wide
		wb_scope_sdcard_stall, wb_scope_sdcard_ack, wb_scope_sdcard_idata,
			scope_sdcard_int);
