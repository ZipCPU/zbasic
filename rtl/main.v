...
`include "builddate.v"
 ...
 // 0x000010
	assign	       flctl_sel = ((wb_addr[22:19] &  4'hf) ==  4'h1); // 0x200000
...
//x2	Was a master bus as well
	...
	begin
		casez({		flctl_ack,
				...
				wb_sio_ack,
				bkram_ack	})
			7'b1??????: wb_idata <= flctl_data;
			7'b01?????: wb_idata <= scope_sdcard_data;
	...
	assign	wb_stall =	((flctl_sel)&&(flctl_stall))
...
`ifdef	INCLUDE_ZIPCPU
	...
	zipsystem #(RESET_ADDRESS,ZIP_ADDRESS_WIDTH,12,ZIP_START_HALTED,ZIP_INTS)
