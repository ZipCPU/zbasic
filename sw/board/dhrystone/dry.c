...
#include <zipsys.h>
// #define	INSN_COUNTER	_zip->z_m.ac_icnt
#define	INSN_COUNTER	_zip->z_nocounters[3]
#define	ZTIMER	_zip->z_tmb
#define CLOCK_TYPE "ziptimer"
#define	HZ	100000000

/*extern  int     times ();*/
                /* see library function "times" */
#define Too_Small_Time 2	// (2*HZ)
                /* Measurements should last at least about 2 seconds */
#define	Start_Timer()	ZTIMER = 0x07fffffff; Begin_Time = 0x07fffffff;
...
#define Mic_secs_Per_Second     1000000.0	// Microseconds per second
...
insn_count = INSN_COUNTER;
  ...
  fprintf (stderr, "\n");
    ...
    // Calculate the number of microseconds for one run of
    // Dhrystone
    //
