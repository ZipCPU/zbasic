...
#define	SDSPI_SETAUX	0x00ff
#define	SDSPI_READAUX	0x00bf
#define	SDSPI_CMD		0x0040
#define	SDSPI_ACMD		(0x040+55) // CMD55
#define	SDSPI_FIFO_OP	0x00800	// Read only
#define	SDSPI_WRITEOP	0x00c00	// Write to the FIFO
#define	SDSPI_ALTFIFO	0x01000
#define	SDSPI_BUSY		0x04000
#define	SDSPI_ERROR	0x8000
#define	SDSPI_CLEARERR	0x08000
#define	SDSPI_CRCERR	0x10000
#define	SDSPI_ERRTOK	0x20000
#define	SDSPI_REMOVED	0x40000
#define	SDSPI_PRESENTN	0x80000
...
static volatile unsigned *const _gpio = ((unsigned *)0x00c0000c);
#endif	// GPIO_ACCESS
#ifdef	VERSION_ACCESS
#define	_BOARD_HAS_VERSION
static volatile unsigned *const _version = ((unsigned *)0x00c00018);
...
static volatile unsigned *const _buspic = ((unsigned *)0x00c00008);
#endif	// BUSPIC_ACCESS
#ifdef	RTC_ACCESS
...
static volatile unsigned *const _buildtime = ((unsigned *)0x00c00000);
#define	_BOARD_HAS_BUSERR
static volatile unsigned *const _buserr = ((unsigned *)0x00c00004);
#ifdef	PWRCOUNT_ACCESS
static volatile unsigned *const _pwrcount = ((unsigned *)0x00c00010);
#endif	// PWRCOUNT_ACCESS
#ifdef	RTCDATE_ACCESS
#define	_BOARD_HAS_RTCDATE
static volatile unsigned *const _rtcdate = ((unsigned *)12582932);
